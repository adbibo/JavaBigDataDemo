 ...
 * Copyright (c) 2016.
 * Author: adbibo
 * Mail: laoliu.yin@gmail.com
 */

package com.adbibo.hbase;

/**
 * Created by adbibo on 2016/12/30.
 */
...
public class HBaseTest {
    ...
    static {
        ...
        conf.set("hbase.zookeeper.quorum", "103.235.226.194");
    ...
    public static void main(String[] args) {
        try {
            ...
            if (isExist(tableName)) {
                ...
                HBaseTest.addRow(tableName, "<span style=\"font-family: Arial, Helvetica, sans-serif;\">henjun</span>", "info", "sex", "boy");
                ...
                HBaseTest.addRow(tableName, "<span style=\"font-family: Arial, Helvetica, sans-serif;\">niaopeng</span>", "info", "sex", "girl");
